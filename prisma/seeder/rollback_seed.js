async function roolbackSeed(prisma) {
    try {
        ...
        await prisma.$executeRaw`TRUNCATE TABLE seat_class, flights, detail_plane, passengers, orders, detail_flight, planes, airlines, cities, countries, continents RESTART IDENTITY`
